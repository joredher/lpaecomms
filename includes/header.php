...
<header class="header navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid px-0">
        <a href="/home" class="navbar-brand text-decoration-none">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 navigation">
                <li class="nav-item">
                    <a href="/home" class="nav-link p-0 <?= strtolower($uri) === '/home' ? $style : '' ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a href="/products" class="nav-link p-0 <?= strtolower($uri) === '/products' ? $style : '' ?>">Products</a>
                </li>
                <li class="nav-item">
                    <a href="/about" class="nav-link p-0 <?= strtolower($uri) === '/about' ? $style : '' ?>">About</a>
                </li>
                <li class="nav-item">
                    <a href="/contact" class="nav-link p-0 <?= strtolower($uri) === '/contact' ? $style : '' ?>">Contact</a>
                </li>
            </ul>
