...
INSERT INTO `lpa_stock` (`lpa_stock_ID`, `lpa_stock_name`, `lpa_stock_desc`, `lpa_stock_features`, `lpa_stock_onhand`, `lpa_stock_price`, `lpa_stock_image`, `lpa_stock_status`, `lpa_fk_category_ID`, `lpa_fk_type_ID`, `lpa_invitem_inv_no`) VALUES
	(1001, 'Wireless Keyboard K580', 'Silent multitasking keyboard with low-profile keys.', '- Wireless connectivity for clutter-free setup. - Low-profile keys for quiet typing. - Compact design ideal for multitasking. - Multi-device switching with easy-access keys. - Long battery life for extended use.', '50', 59.99, 'keyboard1.jpg', 'A', 1, 1, 'INV-001'),
	(1002, 'Gaming Mouse G502', 'High-performance wired gaming mouse with 11 buttons.', '- High-performance optical sensor for precision. - 11 programmable buttons for gaming macros. - Adjustable DPI settings up to 16000. - Tunable weights for personalized feel. - RGB lighting customization.', '30', 89.99, 'mouse1.jpg', 'A', 1, 1, 'INV-002'),
	(1003, 'Stylus Pen SP10', 'Precision stylus for tablets and smartphones.', '- Precision tip for accurate input. - Compatible with most capacitive screens. - Slim, lightweight, and ergonomic. - Ideal for drawing, writing, and navigation. - No batteries or Bluetooth required.', '70', 29.99, 'stylus1.jpg', 'A', 1, 1, 'INV-003'),
	(1004, 'Barcode Scanner BS100', 'Fast laser barcode scanner for retail.', '- Laser scanning for high-speed barcode reading. - Plug-and-play via USB connection. - Durable and ergonomic design. - Ideal for retail and warehouse use. - Compatible with major POS systems.', '40', 119.00, 'scanner1.jpg', 'A', 1, 1, 'INV-004'),
	(1005, 'Webcam Pro W920', 'HD webcam with autofocus and built-in microphone.', '- Full HD resolution for sharp video. - Autofocus for clear image adjustment. - Built-in noise-reducing microphone. - Flexible mounting clip included. - Plug-and-play with USB.', '25', 79.99, 'webcam1.jpg', 'A', 1, 1, 'INV-005'),
	(1006, 'LED Monitor 24"', 'Full HD 24-inch LED display.', '- 24-inch Full HD 1080p display. - Slim bezels for immersive viewing. - HDMI and VGA input ports. - LED backlight for energy efficiency. - Tilt adjustable stand.', '35', 149.99, 'monitor1.jpg', 'A', 2, 3, 'INV-006'),
	(1007, 'Bluetooth Speaker BX50', 'Portable speaker with deep bass.', '- Bluetooth 5.0 connectivity. - Deep bass and rich audio quality. - Up to 10 hours battery life. - Built-in mic for calls. - Compact and portable design.', '45', 89.50, 'speaker1.jpg', 'A', 2, 3, 'INV-007'),
	(1008, 'Thermal Printer TP20', 'Compact thermal receipt printer.', '- Thermal printing technology. - Fast receipt printing speed. - Compact footprint saves space. - Easy paper loading design. - USB interface for easy setup.', '15', 199.99, 'printer1.jpg', 'A', 2, 3, 'INV-008'),
	(1009, 'Smart TV 40"', 'Smart TV with built-in apps.', '- 40-inch Full HD Smart TV. - Built-in streaming apps. - Multiple HDMI and USB ports. - Energy-efficient LED panel. - Remote control included.', '10', 349.00, 'tv1.jpg', 'A', 2, 3, 'INV-009'),
	(1010, 'Audio Dock Station', 'High-fidelity audio docking system.', '- High-fidelity stereo sound. - Multiple device docking support. - Remote control functionality. - USB and AUX input compatibility. - Compact and modern design.', '20', 129.00, 'dock1.jpg', 'A', 2, 3, 'INV-010'),
	(1011, 'External HDD 2TB', 'Reliable storage for large files.', '- 2TB of external storage capacity. - USB 3.0 high-speed interface. - Shock-resistant housing. - Plug-and-play compatibility. - Ideal for large file backups.', '20', 109.50, 'hdd1.jpg', 'A', 3, 4, 'INV-011'),
	(1012, 'USB Flash Drive 64GB', 'Portable flash drive.', '- 64GB of portable storage. - Fast data transfer via USB 3.0. - Lightweight and durable. - Plug-and-play with any OS. - Secure and reliable design.', '100', 19.99, 'usb1.jpg', 'A', 3, 4, 'INV-012'),
	(1013, 'SSD 500GB', 'Fast internal solid-state drive.', '- 500GB SSD storage. - Fast read/write speeds. - Enhanced system performance. - Compact and lightweight. - Ideal for laptops and desktops.', '35', 89.00, 'ssd1.jpg', 'A', 3, 4, 'INV-013'),
	(1014, 'Memory Card 128GB', 'MicroSDXC memory card.', '- 128GB MicroSDXC capacity. - High-speed data transfer. - Compatible with phones and cameras. - Durable and shockproof. - Includes SD adapter.', '80', 24.99, 'sdcard1.jpg', 'A', 3, 4, 'INV-014'),
	(1015, 'NAS Storage Unit', 'Network attached storage with 4 bays.', '- Supports 4 hard drive bays. - Reliable NAS for data sharing. - Built-in data redundancy. - Remote access functionality. - Secure user access controls.', '5', 599.99, 'nas1.jpg', 'A', 3, 4, 'INV-015'),
	(1016, 'Wi-Fi Router AX1800', 'High-speed wireless router.', '- Dual-band AX1800 Wi-Fi. - Fast wireless speed. - Wide coverage and stable signal. - Easy mobile app setup. - Supports multiple devices.', '25', 120.00, 'router1.jpg', 'A', 4, 1, 'INV-016'),
	(1017, 'Ethernet Switch 8-Port', 'Unmanaged gigabit switch.', '- 8-port Gigabit Ethernet switch. - Unmanaged, plug-and-play setup. - Compact and fanless design. - Energy-efficient operation. - Ideal for small networks.', '30', 59.00, 'switch1.jpg', 'A', 4, 1, 'INV-017'),
	(1018, 'Wireless Access Point', 'Seamless Wi-Fi expansion device.', '- Boosts existing Wi-Fi coverage. - Supports dual-band connectivity. - Simple setup and management. - Wall-mountable design. - Stable and fast connections.', '18', 139.00, 'accesspoint1.jpg', 'A', 4, 1, 'INV-018'),
	(1019, 'USB Wi-Fi Adapter', 'Mini wireless USB adapter.', '- Mini USB Wi-Fi adapter. - Stable wireless performance. - Compact and low-profile design. - Plug-and-play installation. - Ideal for laptops and PCs.', '60', 25.00, 'adapter1.jpg', 'A', 4, 1, 'INV-019'),
	(1020, 'LAN Cable CAT6', 'High-speed Ethernet cable 5m.', '- Category 6 high-speed cable. - Supports up to 1Gbps transfer. - 5-meter length for flexible use. - Durable and reliable material. - Great for routers and modems.', '200', 9.99, 'cable1.jpg', 'A', 4, 1, 'INV-020');
